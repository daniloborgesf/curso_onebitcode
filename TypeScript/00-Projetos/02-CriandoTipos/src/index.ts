type PlanetaSituacao = 'Habitado' | 'Habitável' | 'Inabitável' | 'Inexplorado'
type PlanetaCoordenada = [number, number, number, number]

type Planeta = {
  nome: string,
  coordenadas: PlanetaCoordenada,
  situacao: PlanetaSituacao,
  satelites: string[]
}

const planetas: Planeta[] = []

function planetaAdicionar(nome: string, coordenadas: PlanetaCoordenada, situacao: PlanetaSituacao) {
  planetas.push({
    nome,
    coordenadas,
    situacao,
...
function planetaBuscar(nome: string) {
...
function promptPlanetaValido(callbackfn: (planeta: Planeta) => void) {
