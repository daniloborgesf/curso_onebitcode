...
addTechBtn.addEventListener("click", function (clickEv) {
  ...
  const expRadio3 = createInput(id1, "(4-6 anos) ", "techExp-" + rowIndex, "radio");
  const expLabel3 = createLabel("(4-6) anos ", id3);
...
form.addEventListener("submit", function (clickEv) {
  clickEv.preventDefault();

  const fullNameImput = document.getElementById("fullname");
