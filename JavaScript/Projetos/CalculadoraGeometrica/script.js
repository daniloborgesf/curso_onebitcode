function calcularAreaTriangulo() {
  ...
  return (base * altura) / 2; // calcular a área do triângulo
}
...
function calcularAreaRetangulo() {
  ...
  return base * altura; // calcular a área do retângulo
}
...
function calcularAreaTrapezio() {
  ...
  return ((baseMaior + baseMenor) * altura) / 2; // calcular a área do trapézio
}

function calcularAreaCirculo() {
  const raio = parseFloat(prompt("Informe o raio do círculo:"));
  return 3.14 * raio * raio; // calcular a área do círculo
}
...
function executar() {
  ...
  do {
    ...
    if (resultado) {
      alert("Resultado: " + resultado); // condicional para exibir o resultado
    }
  } while (opcao !== "6");
}

executar(); // executa a função
